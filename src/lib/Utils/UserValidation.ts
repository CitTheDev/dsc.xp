import { UserFetchData, ValidationData } from "../Interfaces/index.js";
 ...
 */
export function validateUserOptions(options: UserFetchData): ValidationData {
 ...
 * @param options - The options needed for the validation
 */
export async function fetchSchema(options: UserFetchData) {
